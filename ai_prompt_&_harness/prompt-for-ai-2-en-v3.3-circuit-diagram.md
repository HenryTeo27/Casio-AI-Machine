...
Do not regenerate, beautify, normalize, or reinterpret the diagram.
...
- Do not change the relative positions of wires, contacts, coils, or labels.
- Do not remove leading spaces.
- Do not trim line endings if they affect alignment.
- Do not rewrite the diagram from memory.
...
For diagram blocks, the task is layout extraction, not diagram redrawing.
